    ...
    <style>
     ...
     <div class="container">
        <div class="header">
            ...
            <p class="contract-subtitle">محرر بتاريخ <?php echo e(\Carbon\Carbon::now()->format('Y/m/d')); ?></p>
        </div>  
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            ...
            <div class="contract-subtitle">محرر بتاريخ <?php echo e(\Carbon\Carbon::now()->format('Y/m/d')); ?></div>
        </div>
        ...
        <div class="content">
                        ...
                        <table class="detail-table">
                            <tr>
                                ...
                                <td class="detail-value">
                                    <span style="color:#1d4ed8;"><?php echo e($contract->landlord_name ?? 'غير محدد'); ?></span>
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <div class="property-section">
                ...
                <table class="detail-table">
                    <tr>
                        ...
                        <td class="detail-value">
                            <span style="color:#1d4ed8;"><?php echo e($contract->property_name_accessor ?? ($contract->property->name ?? 'غير محدد')); ?></span>
                        </td>
                    </tr>
                    <tr>
                        <td class="detail-label">الوحدة:</td>
                        <td class="detail-value">
                            <span style="color:#1d4ed8;"><?php echo e($contract->unit_name_accessor ?? ($contract->unit->name ?? 'غير محدد')); ?></span>
                        </td>
                    </tr>
                    <tr>
                        <td class="detail-label">نوع الاستخدام:</td>
                        <td class="detail-value">
                            <span style="color:#1d4ed8;"><?php echo e($contract->unit->usage_type ?? 'سكني'); ?></span>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <table class="detail-table">
                <tr>
                    ...
                    <td class="detail-value">
                        <span style="color:#1d4ed8;"><?php echo e($contract->start_date ? \Carbon\Carbon::parse($contract->start_date)->format('Y/m/d') : 'غير محدد'); ?></span>
                    </td>
                </tr>
                <tr>
                    <td class="detail-label">تاريخ انتهاء الإيجار:</td>
                    <td class="detail-value">
                        <span style="color:#1d4ed8;"><?php echo e($contract->end_date ? \Carbon\Carbon::parse($contract->end_date)->format('Y/m/d') : 'غير محدد'); ?></span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="detail-value">
                        <span style="color:#1d4ed8;"><?php echo e(number_format($contract->rent_amount ?? 0, 2)); ?> دينار أردني</span>
                    </td>
                </tr>
                <tr>
                    <td class="detail-label">كيفية أداء البدل:</td>
                    <td class="detail-value">
                        <span style="color:#1d4ed8;"><?php echo e($contract->payment_method ?? 'شهري مقدم، يستحق في اليوم الأول من كل شهر ميلادي'); ?></span>
                    </td>
                </tr>
            </table>
                ...
                <table class="signature-table">
                    <tr>
                        <td>
                            ...
                            <?php if($contract->landlord_signature_path && file_exists(public_path('contracts/signatures/' . basename($contract->landlord_signature_path)))): ?>
                                <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('contracts/signatures/' . basename($contract->landlord_signature_path))))); ?>" style="max-width: 150px; max-height: 70px;" />
                            <?php else: ?>
                                <div class="signature-line"></div>
                            <?php endif; ?>
                            <div class="signature-name">
                                <span style="color:#1d4ed8;"><?php echo e($contract->landlord_name ?? '...................................'); ?></span>
                            </div>
                        </td>
                        
                        <td>
                            <div class="signature-title">المستأجر</div>
                            <?php if($contract->tenant_signature_path && file_exists(public_path('contracts/signatures/' . basename($contract->tenant_signature_path)))): ?>
                                <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('contracts/signatures/' . basename($contract->tenant_signature_path))))); ?>" style="max-width: 150px; max-height: 70px;" />
                            <?php else: ?>
                                <div class="signature-line"></div>
                            <?php endif; ?>
                            <div class="signature-name">
        ...
        <div class="footer">
            ...
            <p>تم إنشاء هذا العقد إلكترونياً بتاريخ <?php echo e(\Carbon\Carbon::now()->format('Y/m/d H:i')); ?></p>
            <p>جميع الحقوق محفوظة © <?php echo e(date('Y')); ?></p>
        </div>
    </div>
</body>

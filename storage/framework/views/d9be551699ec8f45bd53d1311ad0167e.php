...
<head>
    ...
    <title><?php echo e($title ?? 'Property Grid'); ?> - JorentV2</title>
...
<body class="bg-light">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('property.grid') ? 'active' : ''); ?>" href="<?php echo e(route('property.grid')); ?>">
                            <iconify-icon icon="solar:buildings-3-bold-duotone" class="me-1"></iconify-icon>
                            Properties
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('contracts.*') ? 'active' : ''); ?>" href="<?php echo e(route('contracts.index')); ?>">
    ...
    <footer class="bg-dark text-white text-center py-4 mt-5">
        <div class="container">
            <p class="mb-0">&copy; <?php echo e(date('Y')); ?> JorentV2. All rights reserved.</p>
        </div>
    </footer>
...
<?php /**PATH C:\Users\mzyz2\Desktop\الجامعة\last\FinalProject\project\jorentV2\resources\views/layouts/app.blade.php ENDPATH**/ ?>
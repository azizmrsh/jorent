...
<div 
    x-data="{ 
        ...
        toggle() {
            ...
            localStorage.setItem('charts_analytics_collapsed', this.collapsed ? '1' : '0');
        },
        init() {
            const saved = localStorage.getItem('charts_analytics_collapsed');
            if (saved !== null) {
...
>
    ...
    <div 
        @click="toggle()" 
        class="cursor-pointer select-none flex items-center justify-between p-4 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-gray-800 dark:to-gray-900 rounded-xl border border-purple-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-200 mb-4"
    >
        <div class="flex items-center space-x-3">
            <span class="text-2xl">📈</span>
            <span class="text-lg font-semibold text-gray-900 dark:text-white">الرسوم البيانية والتحليلات</span>
        </div>
